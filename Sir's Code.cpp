...
void Compute_Wedges() {
    ...
    for (int i = 0; i < number_of_wedges; i++){
        for (int iLy = 1; iLy < 5; iLy++){
            ...
            float phi_min_rad = layer_bounds[i][iLy].wedge_start_rad;
            float phi_max_rad = layer_bounds[i][iLy].wedge_end_rad;
            float phi_min_deg = layer_bounds[i][iLy].wedge_start_Degrees;
            float phi_max_deg = layer_bounds[i][iLy].wedge_end_Degrees;
